...
import 'package:latihan_rs/screen_page/page_rs.dart';
...
class _PageKabupatenState extends State<PageKabupaten> {
  ...
  Future<void> getKabupaten() async {
    ...
    try {
      final response = await http.get(Uri.parse("http://192.168.156.142/project_rumah_sakit/getKabupaten.php"));
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: Card(
                    ...
                    elevation: 5,
                    child: ListTile(
                      leading: Image.asset('gambar/rs2.jpeg', width: 40),
                      title: Text(
